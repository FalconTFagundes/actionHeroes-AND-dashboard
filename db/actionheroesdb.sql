...
--
-- Estrutura para tabela `cardclientes`
--

CREATE TABLE `cardclientes` (
  `idcardclientes` int(10) UNSIGNED NOT NULL,
  `imagemcliente` varchar(45) NOT NULL,
  `comentariocliente` varchar(45) NOT NULL,
...
--
-- Despejando dados para a tabela `cardclientes`
--

INSERT INTO `cardclientes` (`idcardclientes`, `imagemcliente`, `comentariocliente`, `nomecliente`, `profissao`, `ativo`) VALUES
...
--
-- Índices de tabela `cardclientes`
--
...
--
-- AUTO_INCREMENT de tabela `cardclientes`
--
ALTER TABLE `cardclientes`
