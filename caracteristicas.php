            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="position-relative overflow-hidden pe-5 pt-5 h-100" style="min-height: 400px;">
                        <img class="position-absolute w-100 h-100" src="./img/<?php echo $imagem1caracteristicas; ?>" alt="" style="object-fit: cover;">
                        <img class="position-absolute top-0 end-0 bg-white ps-3 pb-3" src="./img/<?php echo $imagem2caracteristicas; ?>" alt="" style="width: 200px; height: 200px">
                    </div>
                </div>
            </div>
        </div>
